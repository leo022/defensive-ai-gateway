...
class ResponseAgentTest(unittest.TestCase):
    ...
    def test_schema_and_static_workbench_contract(self):
        ...
        self.assertIn('renderAgentTraceStep(latest, "latest", tr("agentTraceLatest"))', script)
        self.assertIn('class="response-agent-trace-middle"', script)
        self.assertIn('aria-live="polite" aria-atomic="true"', script)
